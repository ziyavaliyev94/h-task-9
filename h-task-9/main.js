...
//             if (firstName.charAt(firstName.length - 1) == 'q') {
...
//     try {
//         const age100 = users.filter(user => user.age > 100);

//         if (age100.length === 0) {
//             throw new Error('100-dən yuxari yaşi olan istifadəçi tapilmadi!');
//         }
//         console.log('100-dən yuxari yaşi olan istifadəçilər:');
//         age100.forEach(user => {
//             console.log(`${user.name} - Yaş: ${user.age}`);
//         });
//     } catch (error) {
//         console.error(error.message);
//     } finally {
//         console.log('Bütün istifadəçilərin yaşlari:');
//         users.forEach(user => {
//             console.log(`${user.firstName} - Yaş: ${user.age}`);
//         });
//     }
// }
// checkUsersAge();
...
//             return user;
//         } else {
//             throw new Error(users.id + tapilmadi);
//         }
//     } catch (error) {
...
//         if (!user) {
//             throw new Error('Bu ID-li istifadəçi tapilmadi!');
//         }

//         if (!user.address) {
//             throw new Error(`Bu ID-li istifadəçinin ünvani mövcud deyil!`);
//         }

//         console.log(user.firstName + user.address);
...
// Funksiya: İstifadəçi id-sinə görə boy və kilo məlumatlarını yoxlayır
...
//             throw new Error(`Bu ID-li istifadəçinin boyu və ya kilosu eksikdir!`);
//         }

//         console.log(`İstifadəçi ${user.firstName} boyu: ${user.height} sm, kilosu: ${user.weight} kg`);
